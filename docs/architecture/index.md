...
- [GrqaserApp data integration and audio](./grqaserapp-data-integration-and-audio.md) — Mobile app, API consumption, playback; UI/UX from docs/design (Epic 7)
